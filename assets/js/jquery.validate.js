...
// constructor for validator
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            url: "Ingrese una direccion web valida.",
            date: "Introduza una fecha valida.",
            dateISO: "Introduzca una fecha valida (ISO).",
            number: "Ingrese un numero correcto.",
            digits: "Ingrese solo numeros.",
            creditcard: "Please enter a valid credit card number.",
            equalTo: "Intgroduzca el mismo valor de nuevo.",
            maxlength: $.validator.format("Ingrese mas de {0} caracteres."),
